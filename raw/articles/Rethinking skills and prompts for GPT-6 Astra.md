...
created: 2026-09-08
description: "Coding agents have come a long way, and best practices are changing fast. What used to require a lot of handholding and scaffolding no longe..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HRZz7xaWAAMTfPd?format=jpg&name=large)
...
If you’ve ever asked Codex to create a skill, it probably used the [$skill-creator](https://x.com/search?q=%24skill-creator&src=cashtag_click) skill. We recently updated its guidance in a few ways to help mitigate many of the failure modes we've seen in practice.

First, skill descriptions should be as short as possible while making it clear when the model should use them.

![Image](https://pbs.twimg.com/media/HRZ0MiYaIAAeAdI?format=jpg&name=large)
...
![Image](https://pbs.twimg.com/media/HRZ0VrCbwAAtwtk?format=jpg&name=large)
