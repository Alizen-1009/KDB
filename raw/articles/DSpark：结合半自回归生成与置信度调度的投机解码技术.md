...
source: "https://wangjunjian.com/posts/2026-06-28-link-dspark/"
author:
  - "[[军舰]]"
published: 2026-06-28
created: 2026-08-26
description: "这篇研究论文介绍了 DSpark，一个由北京大学和 DeepSeek-AI 联合开发的投机采样（Speculative Decoding）大模型推理加速框架。以下是该论文的核心要点总结： 核心痛点 传统的投机采样在提高大模型推理速度上面临两个瓶颈： 生成质量退化（后缀衰减）： 并行草稿模型（如 DFlash）虽然生成速度快，但因为各 Token 独立预测，缺乏前后依赖关系，容易产生语义冲突（多模态…"
tags:
  - "clippings"
---
![](https://wangjunjian.com/images/2026/dspark/architecture.webp)
